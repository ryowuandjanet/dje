...
class Category(models.Model):
  ...
  image = models.CharField(u'圖片網址',max_length=250, null=False, blank=False)
...
class Product(models.Model):
  ...
  product_image = models.CharField(u'主圖網址',max_length=250, null=False, blank=False)
  product_sub_image = models.CharField(u'次圖網址',max_length=250, null=False, blank=False)
